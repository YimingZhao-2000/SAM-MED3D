...
parser.add_argument('--prompt_mode',    default='mask+point', 
                    choices=['auto', 'center', 'box', 'mask', 'mask+point', 'mask+box', 'none'],
                    help='Prompt type: auto/center/box/mask/mask+point/mask+box/none')
...
def generate_prompt_from_gt(gt_slice, prompt_mode='auto'):
    ...
    gt_binary = (gt_512 > 0).astype(np.uint8)
